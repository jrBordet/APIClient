...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jrBordet/APIClient'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jrBordet' => 'jr.bordet@gmail.com' }
  s.source           = { :git => 'https://github.com/jrBordet/APIClient.git', :tag => s.version.to_s }
